...
function GeminiAssistant() {
  ...
  const handleSendMessage = (textToSend) => {
    ...
    setTimeout(() => {
      ...
      let aiReply = "⚡ **Gemini 3.6 Flash (High) Recommendation**: Based on real-time multi-vendor metrics, your active vendors are operating at 94% fulfillment health. Let me know if you'd like a custom report generated!";

      if (qLower.includes("sales") || qLower.includes("revenue") || qLower.includes("trend")) {
        aiReply = "📊 **Gemini Sales Insights**: Your platform revenue is up +18.4% this month! Top revenue category is **Electronics** (₹899 avg ticket price). Recommend bundling accessories with UltraWide Monitors for a +12% boost.";
        ...
        aiReply = "🏷️ **Smart Pricing Suggestion**: Dynamic pricing model suggests adjusting Wireless Mouse pricing from ₹450 to ₹425 to increase conversion velocity by ~15%.";
      }
